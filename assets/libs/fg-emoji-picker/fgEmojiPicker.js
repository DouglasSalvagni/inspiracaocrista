...
const FgEmojiPicker = function (options) {
    ...
    this.functions = {
        ...
        fetchEmojiData: () => {
            fetch(`../wp-content/themes/DNA-CRM/assets/js/pages/plugins/jsonfull-emoji-list.json`)
    ...
    this.emojiPicker = () => {
        ...
        <div class="fg-emoji-picker">
            ...
            if (this.emojiJson) {
                ...
                fetchData = fetch(`../wp-content/themes/DNA-CRM/assets/js/pages/plugins/jsonfull-emoji-list.json`)
                    .then(response => response.json())
                    .then(object => {
