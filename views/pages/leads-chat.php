<div class="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
    <div class="chat-leftsidebar">
        ...
        <ul class="nav nav-tabs nav-tabs-custom nav-success nav-justified" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#chats" role="tab">Leads</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#contacts" role="tab">Clientes</a>
            </li>
        </ul>
        <div class="tab-content text-muted">
            <div class="tab-pane active" id="chats" role="tabpanel">
                <div class="chat-room-list pt-3" data-simplebar>
                    <div class="d-none align-items-center px-4 mb-2">
                        <div class="flex-grow-1">
                        ...
                        <ul class="list-unstyled chat-list chat-user-list" id="userList">
                            <?php if (!empty($leads)): ?>
                                <?php foreach ($leads as $lead): ?>
                                    <li id="lead-<?= $lead['ID'] ?>">
                                        <a href="#" data-lead-id="<?= $lead['ID'] ?>">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 chat-user-img online align-self-center me-2 ms-0">
                                                    <div class="avatar-xxs">
                                                        <img src="<?= $lead['lead_image'] ?>"
                                                            class="rounded-circle img-fluid userprofile" alt="">
                                                        <span class="user-status"></span>
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <p class="text-truncate mb-0"><?= $lead['title'] ?></p>
                                                </div>
                                                <div class="ms-auto"><span
                                                        class="badge bg-dark-subtle text-body rounded p-1"></span></div>
                                            </div>
                                        </a>
                                    </li>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <li>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 overflow-hidden">
                                            <p class="text-truncate mb-0">No leads found</p>
                                        </div>
                                    </div>
                                </li>
                            <?php endif; ?>
            ...
            <div class="w-100 overflow-hidden position-relative">
                                        ...
                                        <div class="flex-grow-1 overflow-hidden">
                                            <div class="d-flex align-items-center">
                                                <div
                                                    ...
                                                    <img src="<?= $current_lead['lead_image'] ?? get_template_directory_uri() . '/assets/images/users/user-dummy-img.jpg' ?>"
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="text-truncate mb-0 fs-16">
                                                        <a class="text-reset username"
                                                            data-id="<?php echo $current_lead['ID']; ?>"
                                                            data-bs-toggle="modal" data-bs-target="#editLeadModal">
                                                            <?php echo isset($current_lead) ? $current_lead['title'] : 'Seleione uma conversa'; ?>
                                                        </a>
                                                    </h5>
                                                    <p class="text-truncate text-muted fs-14 mb-0 userStatus">
                                                        <small><?php echo isset($current_lead) ? 'Online' : ''; ?></small>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-8 col-4">
                                    <ul class="list-inline user-chat-nav text-end mb-0">
                                        <li class="list-inline-item m-0">
                                            <div class="dropdown">
                                                <button class="btn btn-ghost-secondary btn-icon shadow-none"
                ...
                <div class="chat-input-section p-3 p-lg-4">
                    <form id="chatinput-form" enctype="multipart/form-data">
                        <input type="hidden" id="current_lead_id" value="<?php echo $current_lead_id; ?>">
