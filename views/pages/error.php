                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body p-4">
                            <div class="text-center">
                                ...
                                <h4 class="text-uppercase">Desculpe, houve um erro 😭</h4>
                                <p class="text-muted mb-4">O erro já foi reportado e estaremos trabalhando para resolvê-lo assim que possível!</p>
                            </div>
                        </div>
                    </div>
                    <!-- end card -->
